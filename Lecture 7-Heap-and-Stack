public class primitiveDT {
    public static void main(String[] args) {
        //Java is not purely object oriented beacuse primitive DataTypes are not object.
        //We can create onjects from them using the wrapper classes -> Integer, Double
        int x = 5;
        int y = 7;
        ...
        //Tasl - 1:Different ways to convert charact to int
        ...
        int m = 5;
        int n = m++; // assign the value of m and ten increase value of m whenever it was defined
        // think of this as:
        // 1. int n = m;
        // m= m + 1;
        ...
        int p = 5;
        int q = ++p; // increase value of p and assign to q
        //think of this as:
        // 1. p = p + 1;
        // 2. int q = p;
